...
public class RegistrosPersonalView extends javax.swing.JDialog {

    public RegistrosPersonalView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tablaRegistros.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
